...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-2 left-2 right-2 z-50 md:hidden rounded-t-3xl backdrop-blur-md bg-muted/30 shadow-[0_-20px_25px_-5px_rgba(0,0,0,0.1),_0_-10px_10px_-5px_rgba(0,0,0,0.04)] py-2 px-4">
